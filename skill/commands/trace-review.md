...
1. Read `.promptrace/component-map.json` for component modification dates
2. Read `.promptrace/config.json` for sync target paths
...
5. Write results to `.promptrace/drift.json`
