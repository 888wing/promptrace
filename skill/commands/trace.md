...
1. Read `.promptrace/config.json` for project context and component roots
2. Read `.promptrace/component-map.json` for the current component registry
...
6. Save to `.promptrace/traces/{YYYY-MM-DD}_{HH-MM}_{slug}.md`
7. Update `.promptrace/component-map.json`:
